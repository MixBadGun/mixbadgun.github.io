...
**1.5.0 版本过后**，新增了「缩放大小」项。此项可以缩放石墩的大小，其相应可以被触发的轨道范围也会变化。例如，如果你想把石墩子放大 2 倍，则此项处填 2。

**2.2.1 版本过后**，新增了「Y轴偏移量」项。此项可以直接让音符在 Y 轴上进行偏移，即改变石墩子所在的高度。例如，如果你想把石墩子升高 1 格，则此项处填 1。
...
### 背景前显音符
**在 1.5.2 版本过后**，背景的图片 / 视频可以通过这个音符覆盖在游戏画面上。
